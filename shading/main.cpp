...
int main(int argc, char** argv) {
	...
	glfwSetErrorCallback(shading::error_callback);
	...
	// Keyboard Callback
	glfwSetKeyCallback(window, shading::key_callback);
	// Framebuffer resize callback
	glfwSetFramebufferSizeCallback(window, shading::framebuffer_size_callback);
